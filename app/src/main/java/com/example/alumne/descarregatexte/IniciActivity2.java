 ...
 */
public class IniciActivity2 extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(IniciActivity2.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        String CridadaPost(String adrecaURL, HashMap<String, String> parametres) {
            ...
            try {
                ...
                if (resposta == HttpsURLConnection.HTTP_OK) {
                    ...
                    Log.i("ResConnectUtils", resultat.toString());
                } else {
